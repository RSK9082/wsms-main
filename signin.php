...
<!-- testing the page  -->
			...
			<!-- Contact -->
			<!-- <div>
				<button id="button_back" onclick="button_t()">Home</button>
			</div> -->


			<div class="contact">
				<div class="container">
					<!-- <img src="images/logo.png" height="130px" width="200px" alt=""> -->
					<div class="row">
						<div class="col">
	...
	<!-- <script>
		function button_t() {
			location.href = "C:\xampp\htdocs\wsms\detailed-page.php";
		};
	</script> -->
